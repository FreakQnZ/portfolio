  ...
  return (
    <div className=" text-white w-full flex flex-col items-center relative">
      <div className=" w-full">
        <Spotlight
          className="top-20 2xl:-top-32 xl:top-0 lg:left-52 left-0"
          fill="white"
        />
        <Spotlight
          className=" top-48 -left-10 md:-left-32 md:top-40 md:h-[80vh] md:pt-40"
          fill="skyblue"
        />
      ...
      <div className=" z-20 flex flex-col items-center justify-between h-dvh p-2">
        ...
        <div>
          <p className="uppercase tracking-widest text-center p-4 m-4 text-2xl lg:text-6xl">
            Welcome to my
          </p>

          <FlipWords
            words={["Portfolio", "Blog", "Diary", "Space"]}
            duration={2000}
          />
        </div>
        ...
        <div>
          <div className=" text-lg text-center m-4">
            Hi I&apos;m Anuraag, A fourth year undergrad CSE - AIML student at
            PES University
          </div>
          ...
          <div className="flex justify-center text-center p-2">
            ...
            >
              <span onClick={scrolltofirst} className="px-5">
                Let&apos;s Go
              </span>
            </HoverBorderGradient>
          </div>
