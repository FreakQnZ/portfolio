...
const AnimatedPinDemo = () => {
  ...
  const items = [
    {
      title: "Tutor",
      description: "AI pipeline for processing videos and PDFs using Kafka.",
      placeholder: "Github Link",
      href: "https://github.com/FreakQnZ/Tutor",
      img: "/architecture.png",
      imgClass: "pt-10 pl-10",
      width: 200,
    },
    {
      title: "Split",
      description:
        "Next js App to add bills, split them among friends and keep track of expenses.",
      placeholder: "Site Link",
      href: "https://expensesplit.vercel.app/",
      img: "/split.png",
      imgClass: "pt-10",
      width: 300,
    },
    {
      title: "Samvaada",
      description:
        "Agentic AI App to Communicate with Enterprise Database using LangGraph",
      placeholder: "Github Link",
      href: "https://github.com/FreakQnZ/Samvaada",
      img: "/samvaada.png",
      imgClass: "pt-10",
      width: 300,
    },
    {
      ...
      description: "Chat App with Websockets for anonymous chating in rooms",
      placeholder: "Site Link",
      href: "https://anonychat-black.vercel.app/",
      img: "/chat.png",
      imgClass: "pt-10",
      width: 300,
    },
    {
      title: "Robin Internships",
      description:
        "Platofrom originally created for handling College fest student internships.",
      placeholder: "Github Link",
      href: "https://github.com/FreakQnZ/robin-internships",
      img: "/robin.png",
      imgClass: "pt-10",
      width: 300,
    },
    {
      title: "Task Manager",
      description:
        "Task Manager web application with auth using clerk and a responsive and unique design.",
      placeholder: "Github Link",
      href: "https://github.com/FreakQnZ/Task-Manager-Web-Application",
      img: "/taskmanager.png",
      imgClass: "pt-6",
      width: 300,
    },
    {
      title: "Auth Module",
      description:
        "Auth module made from scratch using JWT, includes signup login and forgot password feature",
      placeholder: "Github Link",
      href: "https://github.com/FreakQnZ/Auth-Module",
      img: "/jwt.png",
      imgClass: "",
    ...
    },
    {
      title: "Churn Prediction",
      description:
        "Using Tensorflow to create a Deep Learning Model to predict Customer Loyalty",
      placeholder: "Github Link",
      href: "https://github.com/FreakQnZ/Neural-Network-Project",
      img: "/churn.png",
      imgClass: "pt-6 pl-10",
    ...
    },
    {
      title: "And Much More on my Github",
      description:
        "Check out my Github for more projects and projects I am working on.",
      placeholder: "Github Link",
      href: "https://github.com/FreakQnZ",
      img: "/github.png",
      imgClass: "pt-6 pl-16",
  ...
  return isClient ? (
    <section
      id="first"
      className=" w-full bg-slate-950 flex flex-col items-center justify-between"
    >
      <div className="text-4xl text-center p-12">Projects</div>
      <div className=" relative w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 items-center justify-center gap-12 pb-10">
        {items.map((item, i) => (
          ...
          <PinContainer key={i} title={item?.placeholder} href={item?.href}>
            <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
              <h3 className="max-w-xs !pb-2 !m-0 font-bold  text-base text-slate-100">
                {item.title}
              </h3>
